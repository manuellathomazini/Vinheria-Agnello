...
Cuidado com armazenamento e qualidade dos produtos
...
O site foi desenvolvido utilizando HTML e CSS, seguindo boas práticas de organização e semântica.

📄 Páginas do projeto
index.html (Página Inicial)
Apresentação da vinheria, destaques e introdução ao site.
[contato.html]
Página onde se encontra nossas redes sociais e o furmulário de cadastro para contato
[harmonização.html]
Explica os tipos de uvas de cada vinho e as melhores combinações
[sobre-nos.html]
...
Estrutura semântica com HTML5 (header, main, section, footer)
Menu de navegação funcional em todas as páginas
Inserção de imagens e conteúdo visual
...
Manuella Sousa Thomazini - 573606
